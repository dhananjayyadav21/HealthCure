  ...
  return (
    <>
        <div className='container-fluid my-3'>
          ...
          <i className="fa-solid error-icon fa-circle-exclamation"></i> You missed your scheduled appointment. Please reschedule at your earliest convenience to ensure timely care.
          </h5>
