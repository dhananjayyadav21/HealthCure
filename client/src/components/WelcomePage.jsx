    ...
    <>
       <div className="get-start d-flex flex-column justify-content-between align-items-center my-4 gap-5 text-center">
         ...
         <div className='d-flex flex-column gap-3'>
            <Link to="/signin"><button className='btn btn-info text-white text-bold'>Sing Up</button></Link>
            <Link to="/signup"><button className='btn btn-info text-white text-bold'>Sing In</button></Link>
         </div>  
       </div>
    </>
  )
